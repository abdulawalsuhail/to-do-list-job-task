...
const Completed = () => {
    ...
    const {
        ...
        fetch(
            `http://localhost:5000/completedTask/${user?.email}`
        ).then((res) => res.json())
    );
    ...
    return (
        <div className="overflow-x-auto text-slate-800  min-h-screen">
            <div
                data-aos="zoom-out"
                className=" lg:w-8/12 mx-auto  p-8 rounded-md mt-10 w-fit"
            >
